...
2) Automated Privacy Assessment for Android Applications: A DPV Visualisation Approach *(March 2025)* \\
3) Explaining Privacy-Relevant Program Slices to App Developers *(Jan 2025)* \\
4) Automatically Generating Data Safety Section Labels for Android Apps *(Jan 2025)* \\
5) Improving User Experience of Program Slicing wrt Data Privacy *(Dec 2023)* \\
6) Labeling User-Input Privacy Data in Android Applications *(July 2023)* \\
...
Additionally, I have supervised the following Master seminars:
